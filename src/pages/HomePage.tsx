...
const JOBS = [
  {
    ...
    description: "Looking for a reliable RDA to assist with general procedures and patient prep with 2+ years experience, California RDA license required.",
    proposalsRDA: 22,
  ...
  },
  {
    ...
    description: "Seeking an experienced RDA for a busy orthodontic practice. Must be detail-oriented and great with patients.",
    proposalsRDA: 15,
  ...
  },
  {
    ...
    description: "Join our team! We need an RDA for surgical assistance. Experience with implants preferred. Fast-paced environment with great team support.",
    proposalsRDA: 27,
...
export default function HomePage() {
  return (
    <div className="min-h-screen mr-5 ml-5 bg-white-50">
      <Header />

      <main className="container mx-auto px-4 py-6">
        <h1 className="text-2xl font-bold mb-6">Welcome to Synapses</h1>
        ...
        <div className="text-center my-6">
          ...
          <p className="text-sm text-gray-500">Find verified professionals you can hire for your own cases</p>
        </div>
