    ...
    <header className="border-b bg-white ">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-6 w-156 h-20 ">
          ...
          <nav className="font-bold hidden md:flex items-center space-x-6 h-6 w-52">
            <a href="#">
              Home
            </a>
            <a href="#">
        ...
        <div className="flex items-center gap-4 w-117 h-12">
          <div className="relative flex items-center bg-gray-100 rounded-full px-3 py-1 w-75 h-10">
